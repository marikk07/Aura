...
- (void)setup
{
   ...
   // [self.editor fixZoomScaleWithAnimated:YES];
    ...
    [_rotateSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/thumb", [self class]]] forState:UIControlStateNormal];
    [_rotateSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/thumb", [self class]]] forState:UIControlStateHighlighted];
    
    [_rotateSlider setMinimumTrackTintColor:[UIColor whiteColor]];
    [_rotateSlider setMaximumTrackTintColor:[UIColor darkGrayColor]];
