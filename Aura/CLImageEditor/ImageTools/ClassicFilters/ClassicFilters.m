...
#import "ClassicFilters.h"
#import "ClassicBase.h"


@implementation ClassicFilters
{
...
+ (NSArray*)subtools
{
    return [CLImageToolInfo toolsWithToolClass:[ClassicBase class]];
}

+ (NSString*)defaultTitle
{
   // return NSLocalizedStringWithDefaultValue(@"ClassicFilters_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Classic", @"");
    return false;
}
...
#pragma mark- SET CLASSIC FILTERS MENU =========================
...
- (UIImage*)filteredImage:(UIImage*)image withToolInfo:(CLImageToolInfo*)info
{
    @autoreleasepool {
        ...
        if([(Class)filterClass conformsToProtocol:@protocol(ClassicBaseProtocol)]){
