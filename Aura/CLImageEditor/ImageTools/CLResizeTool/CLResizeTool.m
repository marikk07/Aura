...
- (void)setup
{
   ...
   // [self.editor fixZoomScaleWithAnimated:YES];
    ...
    _menuScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, _menuContainer.width - 50, _menuContainer.height)];
    _menuScroll.backgroundColor = [UIColor clearColor];
    _menuScroll.showsHorizontalScrollIndicator = NO;
    _menuScroll.clipsToBounds = NO;
    [_menuContainer addSubview:_menuScroll];
    
    UIView *btnPanel = [[UIView alloc] initWithFrame:CGRectMake(_menuScroll.right, 0, 50, _menuContainer.height)];
    btnPanel.backgroundColor = [_menuContainer.backgroundColor colorWithAlphaComponent:0.97];
    [_menuContainer addSubview:btnPanel];
    
    _switchBtn = [CLImageEditorTheme menuItemWithFrame:CGRectMake(0, 0, 50, btnPanel.height) target:self action:@selector(pushedSwitchBtn:) toolInfo:nil];
    _switchBtn.tag = 0;
...
- (UIImage*)imageWithString:(NSString*)string
{
    ...
    label.backgroundColor = [UIColor colorWithWhite:0.9 alpha:0.2];
    label.textColor = [UIColor colorWithWhite:1.0 alpha:1];
...
- (void)initInfoPanel {
    ...
    label.textAlignment = NSTextAlignmentCenter;
    label.textColor = [UIColor whiteColor];
    label.font = [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:24];
    ...
    label.textColor = [UIColor whiteColor];
    label.font = [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:20];
    label.text = NSLocalizedStringWithDefaultValue(@"CLResizeTool_InfoPanelTextNewSize", nil, [CLImageEditorTheme bundle], @"Set New Image Size:", @"");
    [_infoPanel addSubview:label];
    y = label.bottom;
    ...
    _fieldW.font = [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:22];
    ...
    _fieldH.font = [UIFont fontWithName:@"AvenirNextCondensed-Regular" size:22];
