...
+ (NSDictionary*)defaultFilterInfo
{
    ...
    if(defaultFilterInfo==nil){
        ...
        @{
            ...
            // New Filters =============
            @"DottedFilter"    : @{@"name":@"CIDotScreen",            @"title":NSLocalizedStringWithDefaultValue(@"DottedFilter_DefaultTitle",   nil, [CLImageEditorTheme bundle], @"Dotted", @""),     @"version":@(6.0), @"dockedNum":@(14.0)},
            
            @"PurpleizedFilter"    : @{@"name":@"CIColorMonochrome",            @"title":NSLocalizedStringWithDefaultValue(@"PurpleizedFilter_DefaultTitle",   nil, [CLImageEditorTheme bundle], @"Purpleized", @""),     @"version":@(6.0), @"dockedNum":@(15.0)},
            
             @"LusterFilter"    : @{@"name":@"CIColorControls",            @"title":NSLocalizedStringWithDefaultValue(@"LusterFilter_DefaultTitle",   nil, [CLImageEditorTheme bundle], @"Luster", @""),     @"version":@(6.0), @"dockedNum":@(16.0)},
...
// New Filters =====
@interface DottedFilter : CLDefaultEmptyFilter
@end
@implementation DottedFilter
@end

@interface PurpleizedFilter : CLDefaultEmptyFilter
@end
@implementation PurpleizedFilter
@end

@interface LusterFilter : CLDefaultEmptyFilter
@end
