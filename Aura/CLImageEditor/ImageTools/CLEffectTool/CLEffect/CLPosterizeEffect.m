...
- (void)setUserInterface
{
    ...
    [_levelSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/thumb", [self class]]] forState:UIControlStateNormal];
    [_levelSlider setThumbImage:[CLImageEditorTheme imageNamed:[NSString stringWithFormat:@"%@/thumb", [self class]]] forState:UIControlStateHighlighted];
    
    [_levelSlider setMinimumTrackTintColor:[UIColor whiteColor]];
    [_levelSlider setMaximumTrackTintColor:[UIColor darkGrayColor]];
