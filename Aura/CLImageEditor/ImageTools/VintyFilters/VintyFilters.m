...
#import "VintyFilters.h"
#import "VintyBase.h"


@implementation VintyFilters
{
...
+ (NSArray*)subtools
{
    return [CLImageToolInfo toolsWithToolClass:[VintyBase class]];
}

+ (NSString*)defaultTitle
{
    // return NSLocalizedStringWithDefaultValue(@"VintyFilters_DefaultTitle", nil, [CLImageEditorTheme bundle], @"Amber", @"");
    return false;
}
...
- (UIImage*)filteredImage:(UIImage*)image withToolInfo:(CLImageToolInfo*)info
{
    @autoreleasepool {
        ...
        if([(Class)filterClass conformsToProtocol:@protocol(VintyBaseProtocol)]){
