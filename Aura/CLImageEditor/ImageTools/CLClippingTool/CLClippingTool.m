...
+ (NSArray*)defaultPresetRatios
{
    return @[
             ...
             @{kCLClippingToolRatioValue1:@1, kCLClippingToolRatioValue2:@1, kCLClippingToolRatioTitleFormat:@"Square"},
...
- (void)setup
{
   // [self.editor fixZoomScaleWithAnimated:YES];
    ...
    CGFloat buttonWidth = (swapBtnHidden) ? 0 : 50;
    ...
    if(!swapBtnHidden){
        ...
        UIView *btnPanel = [[UIView alloc] initWithFrame: CGRectMake(_menuScroll.right, 0, 50, _menuScroll.height)];
        btnPanel.backgroundColor = [UIColor colorWithRed:48.0/255.0 green:55.0/255.0 blue:59.0/255.0 alpha:1.0];
        btnPanel.clipsToBounds = YES;
        
        // Rounds the view
        //btnPanel.layer.cornerRadius = btnPanel.frame.size.width/2;
       ...
       // btn.layer.cornerRadius = btn.bounds.size.width /2;
        ...
        btn.center = CGPointMake(btnPanel.width/2, btnPanel.height/2);
